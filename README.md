...
시큐리티설정, JWT, JPA, Mokito, Swagger 등등 이전에 실무에서 경험해보지 못하여 최근에 개인적으로 공부를 하였던 기술들을 활용할 수 있는 기회가 되어 너무 재미있는 일주일이였습니다  
밤 잠 줄여가며 최대한 시간을 활용해봤지만 많은 시행착오를 거치면서 하다보니 시간에 쫓겨 완성도 높은 코드를 만들지 못한점이 많이 아쉬웠습니다  
비록 서투른 코드지만 과제 진행하면서 많이 발전할수 있었고 덕분에 너무 재미있는 일주일을 보냈습니다  
좋은 경험 할수있게 해주셔서 감사합니다 :)
